...
public class GamePlayerInfoTopFivePerGameImpl implements IGamePlayerInfoTopFivePerGame{
	...
	public Map<Long, Map<Long, Long>> findTopFivePerGame(List<GamePlayerInfo> gamePlayerInfoList) {
		...
		{		
			...
			//find top five players per game
			gamePlayerInfoTopMap = findTopFivePerGame(gamePlayerInfoMap);
			
		}
		return gamePlayerInfoTopMap;
	}
	
	private Map<Long, Map<Long, Long>> findTopFivePerGame(Map<Long, Map<Long, Long>> gamePlayerInfoMap) {
		// TODO Auto-generated method stub
		Map<Long, Map<Long, Long>> gamePlayerInfoTopMap = new HashMap<Long, Map<Long, Long>>();
