...
public class GamePlayerInfoTestBottomPlayers{

    @Test		
    public void testGamePlayerInfoBottomPlayers()
    {           
    	...
    	try
    	{
    		...
    		Map<Long, Long> mapPlayerBottomPoints = gamePlayerInfoMapBottomFive.get(1L);
    		List<Long> bottomPointsList = mapPlayerBottomPoints.values().stream().collect(Collectors.toList());
    		assertEquals(Long.valueOf(100L), bottomPointsList.get(0));
    		assertEquals(Long.valueOf(110L), bottomPointsList.get(1));
    		assertEquals(Long.valueOf(120L), bottomPointsList.get(2));
    		assertEquals(Long.valueOf(130L), bottomPointsList.get(3));
    		assertEquals(Long.valueOf(140L), bottomPointsList.get(4));
