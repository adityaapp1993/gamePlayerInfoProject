...
public class GamePlayerInfoTestTopPlayers{
    ...
    {           
    	...
    	try
    	{
    		...
    		Map<Long, Long> mapPlayerTopPoints = gamePlayerInfoMapTopFive.get(1L);
    		List<Long> topPointsList = mapPlayerTopPoints.values().stream().collect(Collectors.toList());
    		assertEquals(Long.valueOf(150L), topPointsList.get(0));
    		assertEquals(Long.valueOf(140L), topPointsList.get(1));
    		assertEquals(Long.valueOf(130L), topPointsList.get(2));
    		assertEquals(Long.valueOf(120L), topPointsList.get(3));
    		assertEquals(Long.valueOf(110L), topPointsList.get(4));
